...
def test_expired_access_token():
    ...
    with pytest.raises(jwt.ExpiredSignatureError):
        expired_token = 'ewogICJhbGciOiAiSFMyNTYiLAogICJ0eXAiOiAiSldUIgp9.ewogICJzdWIiOiAiZ3l1YmVvbSIsCiAgInRva2VuX3R5cGUiOiAiYWNjZXNzX3Rva2VuIiwKICAiZXhwIjogMTUyNDYwODAwMAp9.gvVieCfSwHPGVKvoRY2deQGqqxDda2R0kn6ZsSIdtMA'
