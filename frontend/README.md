...
| `/generate/shorts` | AI 숏츠 만들기 / **간편 숏츠 만들기** | **backend 연결 완료** — `/api/v1/video-jobs`(#68)로 접수→폴링→9:16 재생·다운로드까지 동작합니다. 클립 2~8개·역할(시술 전/과정/디테일/마무리)·사용 구간·자막(AI 자막 생성 포함)·얼굴 자동 블러·24시간 TTL. 폰 동선 다듬기(#110), 세로 3단계 화면으로 재구성(#195), 업로드 전 로그인 확인(#193) |
